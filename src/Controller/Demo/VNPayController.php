...
namespace HowMAS\PaymentBundle\Controller\Demo;
...
use HowMAS\PaymentBundle\Service\VNPayService;

/**
 * @Route("/vnpay", name="howmas-demo-vnpay-")
 */
class VNPayController extends BaseController
{
    ...
    public function paymentUrlAction(Request $request)
    {
        ...
        $redirectUrl = $this->generateUrl('howmas-demo-vnpay-return-url', [], UrlGeneratorInterface::ABSOLUTE_URL);
